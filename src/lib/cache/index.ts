...
import { readTokens, writeTokens, type Tokens } from "./tokens";
 ...
 */
export async function readResource(client: CacheClient, resource: "tasks"): Promise<Task[]>;
export async function readResource(client: CacheClient, resource: "events"): Promise<Event[]>;
export async function readResource(
  client: CacheClient,
  resource: "time_slots",
): Promise<TimeSlot[]>;
export async function readResource(client: CacheClient, resource: "labels"): Promise<Label[]>;
export async function readResource(client: CacheClient, resource: "tags"): Promise<Tag[]>;
export async function readResource(
  client: CacheClient,
  resource: "calendars",
): Promise<Calendar[]>;
